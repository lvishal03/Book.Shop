...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (($validationResult = validateName($_POST['name'])) !== true) {
    ...
    if (empty($errors)) {
        ...
        window.location = '?';
            ...
            $sql1 = "INSERT INTO `register`(`name`, `email`, `password`) VALUES ('$name','$email','$pswd')";
            ...
            <div class="card" style="width:400px; height:400px;">
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <button type="submit" name="test" class="btn btn-primary"><b>Submit</b></button>
                    </form>
                    <a class="nav-link hover" href="sign_in.php">Already have an account? <span class="text-info hover">Login now</span></a>
                </div>
            </div>
        </div>
    </div>
