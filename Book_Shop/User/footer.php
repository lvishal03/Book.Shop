            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="section">
                        ...
                        <h1 class="text-light tex">Join Newsletter</h1>
                        <p class="text-light te">Lorem started its journey with cast iron (CI) products in 1980. The intial main objective </p>
                        <p class="text-light txe"> was to ensure pure water and affordable irrigation.</p>
                        <input class="inp" type="text" placeholder="      Enter Your Email">
                        <a class="ipn" href="sign_in.php"><button class="button button2 mt-5">Subscribe</button></a>
                    </div>
                </div>
            </div>
        </div>
